        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="card card-light">
                ...
                <div class="row">
                  <div class="col-lg-6 col-sm-12">
                    ...
                    <div class="form-group">
                      ...
                      <select name='finance_cash_currency' class="form-control select2" style="width: 100%;" disabled>
                        <option value=''></option>
            ...
            <div class="card-footer">
              <a class="btn btn-outline-info" title="Back" href="<?php echo base_url()?>cash/acc"><i class="fab fa-creative-commons-sa"></i> Back</a>
