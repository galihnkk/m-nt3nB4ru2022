      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><small>Update Harga</small></li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="card-body pb-0">
              <div class="row">
                <div class="col-12 col-sm-12 col-md-12 d-flex">
                  ...
                  echo form_open_multipart('harga/edit',$attributes); ?>
                  <input type="hidden" name="id" value="<?=$records['username'] ?>">
                  <input type="hidden" name="id_harga" value="<?php echo $records['id_harga'] ?>">
                  <h4><b>Update Harga</b></h4>
                  <div class="row">
                    ...
                    <div class="col-12 col-sm-12">
                      ...
                      <div class="col-12 col-xs-10">
                        <textarea class="form-control" id="text" name="deskripsi" maxlength="2000" rows="5" value="<?php echo $records['deskripsi'] ?>"><?php echo $records['deskripsi']?></textarea>
