              ...
              <div class="row">
                <div class="col-12 d-flex">
                  <div class="col-sm-6 col-md-6">
                    <a class="btn btn btn-outline-info" href="<?php echo base_url()?>harga">
                   ...
                   <div class="card bg-light d-flex flex-fill">
                       ...
                       <div class="row">
                         <div class="col-12 text-center">
                           <?php if(empty($row['foto_h'])) { ?>
                             <img src="<?php echo base_url()?>assets/backend/images/logo-default.png" class="profile-user-img img-fluid img-circle" alt="User Image">
                           <?php }else { ?>
                             <img src="<?php echo base_url()?>assets/frontend/harga/<?php echo $row['foto_h'];?>" class=" img-fluid">
                           <?php }?>
                     ...
                     <div class="card-footer">
                       <div class="text-right">
                         ...
                         <a href="<?php echo base_url()?>harga/kembalikan/<?php echo $row['id_harga'] ?>" onclick="return confirm('Mengembalikan <?=$row['judul'] ?> lagi?')" class="btn btn-sm bg-teal">
                           <i class="fab fa-creative-commons-sa"></i> Kembalikan
                         </a>
                         <a href="<?php echo base_url()?>harga/hapus/<?php echo $row['id_harga'] ?>" onclick="return confirm('Yakin untuk menghapus <?=$row['judul'] ?> secara permanen?')" class="btn btn-sm btn-primary">
