              ...
              <div class="row">
                <div class="col-12 d-flex">
                  <div class="col-sm-6 col-md-6">
                    <a class="btn btn btn-outline-info" href="<?php echo base_url()?>ringkasan">
                   ...
                   <div class="card bg-light d-flex flex-fill">
                     ...
                     <div class="card-footer">
                       <div class="text-right">
                         <a href="<?php echo base_url()?>ringkasan/kembalikan/<?php echo $row['id_projek'] ?>" onclick="return confirm('Mengembalikan <?=$row['judul'] ?> lagi?')" class="btn btn-sm bg-teal">
                           <i class="fab fa-creative-commons-sa"></i> Kembalikan
                         </a>
                         <a href="<?php echo base_url()?>ringkasan/hapus/<?php echo $row['id_projek'] ?>" onclick="return confirm('Yakin untuk menghapus <?=$row['judul'] ?> secara permanen?')" class="btn btn-sm btn-primary">
