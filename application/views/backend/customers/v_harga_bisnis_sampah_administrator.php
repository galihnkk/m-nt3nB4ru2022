          ...
          <div class="card">
            <div class="card-header">
                <?php if($this->session->level=='105221cd0abe4603ecfee5fb02ba2f398128d131'){ ?>            
                  ...
                  <a class="btn btn btn-info" href="<?php echo base_url()?>harga/sampah_bisnis">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>
                    <?php
                    echo"                  
                    <a class='btn btn-primary btn-sm'title='Kembalikan' href='".base_url()."harga/kembalikan_harga_bisnis/$row[id_harga_session]'><i class='fab fa-creative-commons-sa'></i></a>
                    <a class='btn btn-danger btn-sm' title='Hapus' href='".base_url()."harga/hapus_permanen_harga/$row[id_harga_session]' onclick=\"return confirm('Yakin ingin menghapus secara permanen ?')\"><i class='fas fa-trash-alt'></i></a>";
                    ?>
                  </td>
                  <td><?=$no++?></td>
