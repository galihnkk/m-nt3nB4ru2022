        ...
        <div class="col-md-9">
          <div class="card">
            <div class="card-header">                
                <a class="btn btn-danger" href="<?php echo base_url()?>harga/detail_bisnis/<?php echo $records['user_bisnis_session'] ?>">
                ...
                <?php if($this->session->level=='105221cd0abe4603ecfee5fb02ba2f398128d131'){ ?>
                  <a class="btn btn-outline-danger" href="<?php echo base_url()?>harga/harga_bisnis/<?php echo $records['user_bisnis_session'] ?>">
                  ...
                  <br><br>
                  <a class="btn btn-outline-danger" href="<?php echo base_url()?>harga/tambah_bisnis">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>
                    <?php
                    echo"
                    <a class='btn btn-primary btn-sm' title='Detail' href='".base_url()."harga/detail_bisnis/$row[user_bisnis_session]'><i class='fas fa-eye'></i></a>
                    <a class='btn btn-primary btn-sm' title='Perbarui' href='".base_url()."harga/edit_bisnis/$row[user_bisnis_session]'><i class='fas fa-edit'></i></a>
                    <a class='btn btn-danger btn-sm' title='Hapus' href='".base_url()."harga/hapus_temp_bisnis/$row[user_bisnis_session]' onclick=\"return confirm('Yakin ingin menghapus  ?')\"><i class='fas fa-trash-alt'></i></a>";
                    ?>
                  </td>
                  <td><?=$no++?></td>
                  <td>Nama Nama</td>                 
