      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><small>Uang Muka</small></li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
                ...
                <a class="btn btn-danger" href="<?php echo base_url()?>customer/daftar_klien_uangmuka">
                ...
                <br><br>
                <center><h3>Klien Uang Muka</h3></center>
            </div><!-- /.card-header -->
            <br>
