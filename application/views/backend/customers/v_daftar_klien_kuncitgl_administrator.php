      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><small>Kunci Tanggal</small></li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
                ...
                <a class="btn btn-danger" href="<?php echo base_url()?>customer/daftar_klien_kuncitgl">
                ...
                <br><br>
                <center><h3>Klien Kunci Tanggal</h3></center>
            </div><!-- /.card-header -->
            <br>
