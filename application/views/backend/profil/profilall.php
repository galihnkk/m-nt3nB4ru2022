          ...
          <div class="card card-primary card-outline">
            <div class="card-body box-profile">
              <div class="text-center">
                ...
                <?php }else { ?>
                  <img src="<?php echo base_url()?>assets/frontend/user/<?php echo $users['user_gambar'];?>" class="profile-user-img img-fluid img-circle" alt="User Image">
                <?php }?>
                ...
                <div class="active tab-pane" id="security">
                  ...
                  echo form_open_multipart('aspanel/profil',$attributes); ?>
                    ...
                    <div class="col-sm-9">
                      ...
                      <?php }else { ?>
                        <img src="<?php echo base_url()?>assets/frontend/user/<?php echo $record['user_gambar'];?>" class="img-fluid mb-3">
                      <?php }?>
