        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4 col-md-4">
              ...
              <div class="col-xs-12 col-sm-8 col-md-8">
                  ...
                  <div class="col-md-12">
                        <br>
                        <span><strong>Pilihan Produk Lain dari <?php echo $user_bisnis->namabisnis?></strong></span>
                        <br>
                        <div class="row">
                          <div class="arrows">
                        ...
                        <div class="row">
                          <div class="arrows">
                            <div class="swiper-container hotel-slider" data-autoplay="5000" data-loop="1" data-speed="1000" data-center="0" data-slides-per-view="responsive" data-mob-slides="2" data-xs-slides="2" data-sm-slides="2" data-md-slides="2" data-lg-slides="2" data-add-slides="2">
                              <div class="swiper-wrapper">
                                <?php
                                $user_wo= $this->Crud_m->view_where_ordering('harga', array('harga_id_bisnis'=>'61'),'id_harga','DESC');
                                foreach ($user_wo as $post) {
                                ?>
                                <div class="swiper-slide">
                                    <div class="hotel-item">
                                      <div class="radius-top">
